...
export default function Testimonials() {
  return (
    <section className="py-24 lg:py-32 bg-brite-dark relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-brite-teal/5 blur-[120px]" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-brite-green/5 blur-[100px]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((testimonial) => (
            <div
              ...
              className="relative rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-8 lg:p-10 hover:bg-white/8 hover:border-white/20 transition-all duration-300"
            >
              {/* Quote Mark */}
              <svg
