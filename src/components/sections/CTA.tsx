      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 lg:px-8 text-center">
        ...
        <ScrollReveal delay={0.15}>
          <p className="mt-8 text-lg text-brite-text-light leading-relaxed max-w-2xl mx-auto">
            Dramatically reduce your patients&apos; total expenses. Significantly
            increase your revenue. Get many of your patients back online and
            renewed — with more money and a happier staff.
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.4}>
          <p className="mt-8 text-sm text-brite-text-light">
            Easy sign-up &middot; Prescriptions last 3-5 months &middot; Simple refills
          </p>
        </ScrollReveal>
      </div>
    </section>
