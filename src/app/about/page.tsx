    ...
    <>
      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 bg-brite-dark overflow-hidden">
          ...
          <div className="absolute -bottom-1/4 -left-1/4 w-[600px] h-[600px] rounded-full bg-brite-teal/10 blur-[120px]" />
          <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-lg text-brite-cream/70 leading-relaxed max-w-2xl">
        ...
        <section className="py-24 lg:py-32 bg-brite-cream">
          <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
            <ScrollReveal>
              ...
              <p className="mt-6 text-lg text-brite-text-light leading-relaxed max-w-2xl mx-auto">
